 ...
 * <br><br>
 * @see MyFixedLengthInputFormat
 */
@InterfaceAudience.Public
@InterfaceStability.Stable
public class MyFixedLengthInputFormat extends FileInputFormat<LongWritable, BytesWritable> implements JobConfigurable
{
    ...
    getRecordReader( InputSplit genericSplit, JobConf job, Reporter reporter ) throws IOException
    {
        ...
        return new MyMapRedFixedLengthRecordReader( job, (FileSplit)genericSplit, recordLength );
    }
