...
public class MyMapReduceFixedLengthRecordReader extends RecordReader<LongWritable, BytesWritable>
{
    private static final Log LOG = LogFactory.getLog( MyMapReduceFixedLengthRecordReader.class );

    private int recordLength;
    private long start;
    private long pos;
    private long end;
    private long splitSize; // My extra content
    ...
    public MyMapReduceFixedLengthRecordReader( int recordLength )
    {
    ...
    public void initialize( Configuration job, long splitStart, long splitLength, Path file ) throws IOException
    {
        ...
        splitSize = splitLength; // my extra content
    ...
    public synchronized boolean nextKeyValue() throws IOException
    {
        ...
        //** below code is my extra content
        if( splitSize < recordLength )
        {
            recordLength = (int)splitSize;
            value = new BytesWritable( new byte[recordLength] );
        }
